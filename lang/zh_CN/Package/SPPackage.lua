...
return {
	...
	["sp_ganfuren"] = "SP甘夫人",
	["spshushen"] = "淑慎",
	[":spshushen"] = "每当你回复1点体力后，你可以令一名其他角色回复1点体力或摸两张牌。",
	["spshenzhi"] = "神智",
	[":spshenzhi"] = "准备阶段开始时，你可以弃置所有手牌：若你以此法弃置的牌不少于X张，你回复1点体力。（X为你的体力值）",
	...
	["$fanxiangAnimate"] = "image=image/animate/fanxiang.png" ,
	...
	["$jspdanqiAnimate"] = "image=image/animate/jspdanqi.png" ,
	
	["jsp_jiangwei"] = "J.SP姜维",
	["&jsp_jiangwei"] = "姜维",
	["#jsp_jiangwei"]= "幼麟",
	["fenkun"] = "困奋",
	[":fenkun"] = "<font color=\"blue\"><b>锁定技，</b></font>结束阶段开始时你失去一点体力，然后摸两张牌。",
	["fengliang"] = "逢亮",
	["$fengliangAnimate"]="image=image/animate/fengliang.png",
	[":fengliang"] = "<font color=\"purple\"><b>觉醒技，</b></font>当你进入濒死状态时，你减1点体力上限并将体力值回复至两点，然后获得技能”挑衅”，将技能“困奋”改为非锁定技。",
