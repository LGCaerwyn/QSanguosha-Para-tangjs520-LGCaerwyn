return {
	...
	["neo_gongsunzan"]="翼公孙瓒",
	["neozhulou"]="筑楼",
	[":neozhulou"]= "结束阶段开始时，你可以摸两张牌，然后选择一项：1.失去1点体力；2.弃置一张非基本牌。",
	...
	["neo_zhouyu"]="翼周瑜",
	["neofanjian"]="反间",
	[":neofanjian"]= "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以选择一张手牌和一名其他角色，令该角色先选择一种花色再获得此牌最后展示之，若此牌的花色与其所选的不同，你弃置其两张牌。",
	["designer:neo_zhouyu "] = "凌天翼",
	...
	["neoxiechan"] = "挟缠" ,
	[":neoxiechan"] = "限定技，出牌阶段，你可以与一名角色拼点。若你赢，你视为对其使用一张【杀】。若你没赢，你视为对其使用一张【决斗】。" ,
	["@neoxiechan"] = "战" ,
	...
	["neo_xiahoudun"]="翼夏侯惇",
	["neoganglie"]="刚烈",
	[":neoganglie"]= "每当你受到一次伤害后，你可以选择一名其他角色，进行判定，若结果不为红桃，你选择一项：1.该角色弃置两张手牌；2.对该角色造成1点伤害。",
	["@neoganglie"] = "请选择“刚烈”的目标。" ,
