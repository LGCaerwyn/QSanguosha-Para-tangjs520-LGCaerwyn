...
return {
	...
	["anxu"] = "安恤",
	[":anxu"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以选择手牌数不等的两名其他角色：若如此做，手牌数较少的角色正面朝上获得另一名角色的一张手牌。若该牌不为♠，你摸一张牌。",
	["zhuiyi"] = "追忆",
	...
	["$ZhuiyiAnimate"] = "image=image/animate/zhuiyi.png",
	...
	["gongqi"] = "弓骑",
	[":gongqi"] = "<font color=\"green\"><b>出牌阶段限一次，</b></font>你可以弃置一张牌：若如此做，本回合你的攻击范围无限；若该牌为装备牌，你可以弃置一名其他角色的一张牌。",
